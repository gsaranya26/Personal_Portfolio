...
const AboutSection = () => {
  ...
  To leverage strong analytical skills and a solid foundation in machine learning to develop predictive models and extract actionable insights from data. Eager to apply knowledge of algorithms, data processing, and model evaluation in a collaborative environment, while utilizing hands-on experience with modern frontend technologies to enhance user experiences and support innovative solutions.
</p>
